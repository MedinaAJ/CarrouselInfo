...
class Carrouselinfovc extends Module
{
	// DB file
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Carrousel Boton Comprar');
	...
	public function install()
	{
		...
		*/
		...
		return parent::install() && $this->registerHook('displayMediHookCarrousel') && $this->registerHook('displayHeader') &&
	...
	*/
	public function hookDisplayMediHookCarrousel(){		
		$this->context->controller->addJS($this->_path.'views/js/carrouselinfo.js');
        $this->context->controller->addCSS($this->_path.'views/css/carrouselinfo.css');
